...
const ButtonCheckout = ({ priceId, mode = "subscription", label, redirectToGenerate = false }) => {
  ...
  const handlePayment = async () => {
    ...
    try {
      // Use the generate page as success URL if redirectToGenerate is true
      // This will redirect customers back to the generate page after checkout
      const successUrl = redirectToGenerate 
